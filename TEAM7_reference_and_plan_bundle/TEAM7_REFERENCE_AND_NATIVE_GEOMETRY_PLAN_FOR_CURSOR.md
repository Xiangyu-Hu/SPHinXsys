...
## 12. Stage 10.17 closure criteria

Stage 10.17 can close when:

```text
1. TEAM7 reference CSVs are committed under reference_data/team7;
2. native geometry audit test passes;
3. native source-driven smoke test passes;
4. A1-B1 and A2-B2 Bz probe CSVs are written;
5. comparison to reference Bz data runs;
6. sign convention audit is documented;
7. Jy remains diagnostic unless actual reference data is obtained;
8. all code follows SPHinXsys SYCL CK style and native geometry pipeline.
```
