...
BaseDiffusion::BaseDiffusion(const std::string &species_name,
    ...
    : AbstractDiffusion(),
      diffusion_species_name_(species_name),
...
//=================================================================================================//
IsotropicDiffusion::IsotropicDiffusion(const std::string &species_name,
                                       const std::string &gradient_species_name,
                                       Real d_coeff, Real cv)
    : BaseDiffusion(species_name, gradient_species_name, cv),
      d_coeff_(d_coeff) {}
//=================================================================================================//
...
LocalIsotropicDiffusion::LocalIsotropicDiffusion(const std::string &species_name,
    ...
    : IsotropicDiffusion(species_name, gradient_species_name, diff_background, cv),
...
{
    local_diffusivity_ = base_particles->registerStateVariableData<Real>(
...
DirectionalDiffusion::DirectionalDiffusion(const std::string &species_name,
    ...
    : IsotropicDiffusion(species_name, gradient_species_name, d_coeff, cv),
...
LocalDirectionalDiffusion::LocalDirectionalDiffusion(const std::string &species_name,
                                                     ...
                                                     Real d_coeff, Real bias_d_coeff_,
                                                     Vecd bias_direction, Real cv)
    : DirectionalDiffusion(species_name, gradient_species_name,
...
{
    local_bias_direction_ = base_particles->registerStateVariableDataFromReload<Vecd>("Fiber");
}
//=================================================================================================//
void LocalDirectionalDiffusion::initializeLocalParameters(BaseParticles *base_particles)
{
    ...
    local_transformed_diffusivity_ = base_particles->registerStateVariableData<Matd>(
