...
//=================================================================================================//
Real AcousticRiemannSolver::DissipativePJump(const Real &u_jump, const Real coeff)
{
    return rho0c0_geo_ave_ * u_jump * SMIN(coeff * SMAX(u_jump * inv_c_ave_, Real(0)), Real(1));
}
//=================================================================================================//
