...
NeighborMethod<Base>::SmoothingKernel::SmoothingKernel(
...
//=================================================================================================//
inline Real NeighborMethod<SPHAdaptation, SPHAdaptation>::SmoothingKernel::
...
//=================================================================================================//
template <class ExecutionPolicy, class EncloserType>
NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::SmoothingKernel::SmoothingKernel(
    const ExecutionPolicy &ex_policy, EncloserType &encloser)
    : BaseKernel(encloser),
...
//=================================================================================================//
inline Real NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::SmoothingKernel::
...
NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::NeighborCriterion::
    ...
    : src_pos_(encloser.dv_src_pos_->DelegatedData(ex_policy)),
      ...
      src_h_ratio_(encloser.dv_src_h_ratio_->DelegatedData(ex_policy)) {}
//=================================================================================================//
inline bool NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::NeighborCriterion::
...
NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::ReverseNeighborCriterion::
    ...
    : src_pos_(encloser.dv_src_pos_->DelegatedData(ex_policy)),
      ...
      tar_h_ratio_(encloser.dv_tar_h_ratio_->DelegatedData(ex_policy)) {}
//=================================================================================================//
inline bool NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::
...
//=================================================================================================//
template <class ExecutionPolicy, class EncloserType>
NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::SearchBox::SearchBox(
    const ExecutionPolicy &ex_policy, EncloserType &encloser)
    : src_inv_h_ref_(encloser.src_inv_h_ref_), tar_inv_h_min_(encloser.tar_inv_h_min_),
      src_h_ratio_(encloser.dv_src_h_ratio_->DelegatedData(ex_policy)) {}
//=================================================================================================//
inline BoundingBoxi NeighborMethod<AdaptiveSmoothingLength, AdaptiveSmoothingLength>::
