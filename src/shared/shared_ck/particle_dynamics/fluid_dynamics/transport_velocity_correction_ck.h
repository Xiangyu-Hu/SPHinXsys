...
{
class WithoutKernelSummationCK;
class WithKernelSummationCK;

template <typename SummationTag, typename SummationScope>
class KernelSummationCK;

template <typename SummationScope>
class KernelSummationCK<WithoutKernelSummationCK, SummationScope>
{
  public:
    explicit KernelSummationCK(BaseParticles * /*particles*/) {}
    ...
    class ComputingKernel
    {
      public:
        ...
        ComputingKernel(const ExecutionPolicy &ex_policy,
                        KernelSummationCK<WithoutKernelSummationCK, SummationScope> & /*encloser*/,
                        ComputingKernelType &computing_kernel) {}

        void operator()(size_t /*index_i*/, Vecd & /*kernel_sum*/) const {}
    };
};

template <typename... Parameters>
class KernelSummationCK<WithKernelSummationCK, Inner<Parameters...>>
{
  public:
    explicit KernelSummationCK(BaseParticles *particles)
        : dv_kernel_sum_(particles->template registerStateVariableOnly<Vecd>("KernelSummation")) {}
    ...
    class ComputingKernel
    {
      public:
        template <class ExecutionPolicy, class ComputingKernelType>
        ComputingKernel(const ExecutionPolicy &ex_policy,
                        KernelSummationCK<WithKernelSummationCK, Inner<Parameters...>> &encloser,
                        ComputingKernelType &computing_kernel)
            : kernel_sum_(encloser.dv_kernel_sum_->DelegatedData(ex_policy)) {}

        void operator()(size_t index_i, Vecd &kernel_sum) const
        {
            kernel_sum_[index_i] = kernel_sum;
        }
...
template <typename... Parameters>
class KernelSummationCK<WithKernelSummationCK, Contact<Parameters...>>
{
  public:
    explicit KernelSummationCK(BaseParticles *particles)
        : dv_kernel_sum_(particles->template getVariableByName<Vecd>("KernelSummation"))
    {
    }
    ...
    class ComputingKernel
    {
      public:
        template <class ExecutionPolicy, class ComputingKernelType>
        ComputingKernel(const ExecutionPolicy &ex_policy,
                        KernelSummationCK<WithKernelSummationCK, Contact<Parameters...>> &encloser,
                        ComputingKernelType &computing_kernel) : kernel_sum_(encloser.dv_kernel_sum_->DelegatedData(ex_policy))
        {
        }
...
/*
 * ParticleScopeTypeCK determines the scope of particles for whi<och transport
...
template <class KernelCorrectionType, class ResolutionType, class LimiterType, class ParticleScopeType, class NablaWVSummationType, typename... Parameters>
class TransportVelocityCorrectionCK<Inner<WithUpdate, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>
    : public TransportVelocityCorrectionCKBase<Interaction<Inner<Parameters...>>>
{
    ...
    using NablaWVSummationKernel = typename KernelSummationCK<NablaWVSummationType, Inner<Parameters...>>::ComputingKernel;
  ...
  public:
    ...
    class InteractKernel : public BaseInteraction::InteractKernel
    {
      ...
      protected:
        ...
        NablaWVSummationKernel NablaWV_;
    };
  ...
  protected:
    ...
    KernelSummationCK<NablaWVSummationType, Inner<Parameters...>> NablaWV_method_;
};
//----------------------------------------------
//  2) Partial specialization for Contact<...>
//----------------------------------------------
template <class KernelCorrectionType, class ResolutionType, class LimiterType, class ParticleScopeType, class NablaWVSummationType, typename... Parameters>
class TransportVelocityCorrectionCK<Contact<Wall, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>
    : public TransportVelocityCorrectionCKBase<Interaction<Contact<Wall, Parameters...>>>
{
    ...
    using CorrectionKernel = typename KernelCorrectionType::ComputingKernel;
    using ParticleScopeTypeKernel = typename ParticleScopeTypeCK<ParticleScopeType>::ComputingKernel;
    using NablaWVSummationKernel = typename KernelSummationCK<NablaWVSummationType, Contact<Parameters...>>::ComputingKernel;
  ...
  protected:
    ...
    KernelSummationCK<NablaWVSummationType, Contact<Parameters...>> NablaWV_method_;
};
...
using TransportVelocityCorrectionInnerNoCorrectionBulkParticlesWithoutKernelSummationCK =
    TransportVelocityCorrectionCK<
        Inner<WithUpdate, NoKernelCorrectionCK, SingleResolution, NoLimiter, BulkParticles, WithoutKernelSummationCK>>;

using TransportVelocityCorrectionInnerNoCorrectionBulkParticlesWithKernelSummationCK =
    TransportVelocityCorrectionCK<
        Inner<WithUpdate, NoKernelCorrectionCK, SingleResolution, NoLimiter, BulkParticles, WithKernelSummationCK>>;

using TransportVelocityCorrectionWallNoCorrectionBulkParticlesWithOutKernelSummationCK =
    TransportVelocityCorrectionCK<
        Inner<WithUpdate, NoKernelCorrectionCK, SingleResolution, NoLimiter, BulkParticles, WithoutKernelSummationCK>,
        Contact<Wall, NoKernelCorrectionCK, SingleResolution, NoLimiter, BulkParticles, WithoutKernelSummationCK>>;

using TransportVelocityCorrectionWallNoCorrectionBulkParticlesWithKernelSummationCK =
    TransportVelocityCorrectionCK<
        Inner<WithUpdate, NoKernelCorrectionCK, SingleResolution, NoLimiter, BulkParticles, WithKernelSummationCK>,
        Contact<Wall, NoKernelCorrectionCK, SingleResolution, NoLimiter, BulkParticles, WithKernelSummationCK>>;
