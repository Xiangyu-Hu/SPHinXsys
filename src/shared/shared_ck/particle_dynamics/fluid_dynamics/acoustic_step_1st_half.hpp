    ...
    InteractKernel::interact(size_t index_i, Real dt)
{
    ...
    for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
    {
        ...
        rho_dissipation +=
            riemann_solver_.DissipativeUJump(index_i, index_j, p_[index_i] - p_[index_j]) * dW_ijV_j;
    }
    ...
    InteractKernel::interact(size_t index_i, Real dt)
{
    ...
    for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
    {
        ...
        rho_dissipation +=
            riemann_solver_.DissipativeUJump(index_i, index_j, p_[index_i] - p_j_in_wall) * dW_ijV_j;
    }
    force_[index_i] += force * Vol_[index_i];
    drho_dt_[index_i] += rho_dissipation * rho_[index_i];
}
    ...
    InteractKernel::interact(size_t index_i, Real dt)
{
    ...
    for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
    {
        ...
        force -= riemann_solver_.AverageP(
                 ...
                 2.0 * dW_ijV_j * e_ij;
        rho_dissipation +=
            dW_ijV_j * riemann_solver_.DissipativeUJump(index_i, index_j, p_[index_i] - contact_p_[index_j]);
    }
    force_[index_i] += force * Vol_[index_i];
    drho_dt_[index_i] += rho_dissipation * rho_[index_i];
}
