...
//      <Inner<WithUpdate, KernelCorrectionType, ResolutionType, LimiterType, ParticleScope, Parameters...>
//========================================================================================
...
TransportVelocityCorrectionCK<Inner<WithUpdate, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>::
    ...
    : TransportVelocityCorrectionCKBase<Interaction<Inner<Parameters...>>>(inner_relation),
      ...
      NablaWV_method_(this->particles_)
...
TransportVelocityCorrectionCK<Inner<WithUpdate, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>::InteractKernel::
    ...
    : BaseInteraction::InteractKernel(ex_policy, encloser),
      ...
      NablaWV_(ex_policy, encloser.NablaWV_method_, *this)
{
}

template <class KernelCorrectionType, class ResolutionType, class LimiterType, class ParticleScopeType, class NablaWVSummationType, typename... Parameters>
void TransportVelocityCorrectionCK<Inner<WithUpdate, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>::InteractKernel::
    interact(size_t index_i, Real dt)
{
    ...
    if constexpr (std::is_same_v<NablaWVSummationType, WithKernelSummationCK>)
    {
        ...
        for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
        {
            ...
            inconsistency -= (this->correction_(index_i) + this->correction_(index_j)) * dW_ijV_j * e_ij;
        }
        if (this->within_scope_(index_i))
        {
            this->zero_gradient_residue_[index_i] = inconsistency;
        }
        // store or pass the kernel_sum
        this->NablaWV_(index_i, kernel_sum);
    }
    else
    {
        if (this->within_scope_(index_i))
        {
            // WithoutKernelSummationCK: skip kernel_sum entirely
            for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
            {
                UnsignedInt index_j = this->neighbor_index_[n];
                Real dW_ijV_j = this->dW_ij(index_i, index_j) * Vol_[index_j];
...
template <class KernelCorrectionType, class ResolutionType, class LimiterType, class ParticleScopeType, class NablaWVSummationType, typename... Parameters>
template <class ExecutionPolicy, class EncloserType>
TransportVelocityCorrectionCK<Inner<WithUpdate, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>::UpdateKernel::
...
template <
    class KernelCorrectionType, class ResolutionType, class LimiterType, class ParticleScopeType, class NablaWVSummationType, typename... Parameters>
void TransportVelocityCorrectionCK<
    Inner<WithUpdate, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>::UpdateKernel::
...
//      <Contact<WithUpdate, KernelCorrectionType, ParticleScopeType, Parameters...>>
//========================================================================================

template <class KernelCorrectionType, class ResolutionType, class LimiterType, class ParticleScopeType, class NablaWVSummationType, typename... Parameters>
TransportVelocityCorrectionCK<Contact<Wall, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>::
    ...
    : TransportVelocityCorrectionCKBase<Interaction<Contact<Wall, Parameters...>>>(contact_relation),
      kernel_correction_(this->particles_), NablaWV_method_(this->particles_)
{
...
template <class KernelCorrectionType, class ResolutionType, class LimiterType, class ParticleScopeType, class NablaWVSummationType, typename... Parameters>
void TransportVelocityCorrectionCK<Contact<Wall, KernelCorrectionType, ResolutionType, LimiterType, ParticleScopeType, NablaWVSummationType, Parameters...>>::
