    ...
    InteractKernel::interact(size_t index_i, Real dt)
{
    ...
    for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
    {
        ...
        p_dissipation +=
            riemann_solver_.DissipativePJump(index_i, index_j, u_jump) * dW_ijV_j * corrected_e_ij;
    }
    ...
    InteractKernel::interact(size_t index_i, Real dt)
{
    ...
    for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
    {
        ...
        p_dissipation +=
            riemann_solver_.DissipativePJump(index_i, index_j, u_jump) * dW_ijV_j * face_to_fluid_n;
    }
    drho_dt_[index_i] += density_change_rate * rho_[index_i];
    force_[index_i] += p_dissipation * Vol_[index_i];
}
    ...
    InteractKernel::interact(size_t index_i, Real dt)
{
    ...
    for (UnsignedInt n = this->FirstNeighbor(index_i); n != this->LastNeighbor(index_i); ++n)
    {
        ...
        Vecd vel_diff =
            vel_[index_i] - riemann_solver_.AverageV(index_i, index_j, this->vel_[index_i], contact_vel_[index_j]);
        density_change_rate += 2.0 * vel_diff.dot(correction_(index_i) * e_ij) * dW_ijV_j;
        p_dissipation +=
            riemann_solver_.DissipativePJump((index_i, index_j, vel_[index_i] - contact_vel_[index_j]).dot(e_ij)) *
            dW_ijV_j * e_ij;
    }
    drho_dt_[index_i] += density_change_rate * rho_[index_i];
    force_[index_i] += p_dissipation * Vol_[index_i];
