...
{
  public:
    explicit Interaction(Relation<Inner<RealBody, SmoothingLength<SingleValued>>> &inner_relation)
...
{
    typedef Relation<Contact<SourceIdentifier, Parameters...>> ContactRelationType;
