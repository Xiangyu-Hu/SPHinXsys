...
{
  protected:
    UniquePtrsKeeper<NeighborBuilderContactShell> neighbor_builder_contact_shell_ptrs_keeper_;
  ...
  protected:
    StdVec<NeighborBuilderContactShell *> get_shell_contact_neighbors_;
};
} // namespace SPH
