...
class GeneralContinuum : public WeaklyCompressibleFluid
{
  ...
  public:
    GeneralContinuum(Real rho0, Real c0, Real youngs_modulus, Real poisson_ratio);
...
class PlasticContinuum : public GeneralContinuum
{
  ...
  public:
    PlasticContinuum(Real rho0, Real c0, Real youngs_modulus, Real poisson_ratio,
...
class J2Plasticity : public GeneralContinuum
{
  ...
  public:
    J2Plasticity(Real rho0, Real c0, Real youngs_modulus, Real poisson_ratio,
