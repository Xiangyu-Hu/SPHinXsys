      ...
      mesh_(&getCoarsestMesh())
{
    ...
    dv_particle_index_ = createUniqueQuantity<UnsignedInt, DiscreteVariable>("ParticleIndex", index_list_size);
    dv_cell_offset_ = createUniqueQuantity<UnsignedInt, DiscreteVariable>("CellOffset", total_number_of_cells_ + 1);
}
//=================================================================================================//
