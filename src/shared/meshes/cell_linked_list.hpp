...
BaseCellLinkedList::NeighborSearch::NeighborSearch(
    const ExecutionPolicy &ex_policy, BaseCellLinkedList &cell_linked_list)
    : Mesh(cell_linked_list.getCellLinkedListMesh()),
