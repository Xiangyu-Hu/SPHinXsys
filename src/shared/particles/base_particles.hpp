...
//=================================================================================================//
template <typename DataType>
void BaseParticles::CopyParticleStateCK::
operator()(VariableAllocationPair<AllocatedDataArray<DataType>> &variable_allocation_pair,
...
BaseParticles::CreateRealParticleFrom::ComputingKernel::
    ...
    : total_real_particles_(encloser.sv_total_real_particles_->DelegatedData(ex_policy)),
      ...
      original_id_(encloser.getVariableDataByName<UnsignedInt>("OriginalID")->DelegatedData(ex_policy)),
      copyable_state_data_arrays_(),
