...
class BaseParticles
{
  ...
  public:
    ...
    StdLargeVec<DataType> *registerDiscreteVariable(
        const std::string &variable_name, const InitializationFunction &default_value = [](size_t index) -> DataType
        { return ZeroData<DataType>::value; });
