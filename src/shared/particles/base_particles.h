...
class BaseParticles
{
  ...
  protected:
    ...
    UnsignedInt total_ghost_domains_;
    SingularVariable<UnsignedInt> *sv_total_ghost_particles_;
    DiscreteVariable<UnsignedInt> *dv_ghost_offsets_;

  public:
    /** initialize basic variables after the particles generated by particle generator */
    virtual void
    initializeBasicParticleVariables();
    //----------------------------------------------------------------------
    ...
    UnsignedInt TotalGhostParticles() { return *sv_total_ghost_particles_->Data(); };
    ...
    void incrementTotalGhostDomains(UnsignedInt increment = 1) { total_ghost_domains_ += increment; };
    ...
    void checkRealParticleBound();
    void checkTotalParticleBound();
    DiscreteVariable<UnsignedInt> *allocateGhostOffsets();
    //----------------------------------------------------------------------
  ...
  private:
    ...
    DataType *
    initializeVariable(DiscreteVariable<DataType> *variable, DataType initial_value = ZeroData<DataType>::value);
