...
namespace SPH
{
	...
	public:
		...
		//DataContainerAssemble<GlobalVariable> all_global_data_;
		...
		void registerGlobalVariable(const std::string &variable_name, GlobalVariableType initial_value = GlobalVariableType::Zero());*/
