...
class BaseParticles
{
  ...
  public:
    ...
    DeviceInt* unsorted_id_device_ = nullptr;      /**< copy of unsorted ids stored inside device. */
    DeviceInt* sorted_id_device_ = nullptr;        /**< copy of sorted ids stored inside device. */
    DeviceInt* sequence_device_ = nullptr;         /**< the sequence referred for sorting within device execution. */
