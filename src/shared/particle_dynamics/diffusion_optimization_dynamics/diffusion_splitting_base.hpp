...
OptimizationBySplittingAlgorithmBase<DataType>::
    ...
    : LocalDynamics(inner_relation.getSPHBody()), DataDelegateInner(inner_relation),
      diffusion_(sph_body_->template getMaterialProperty<LocalIsotropicDiffusion>()),
      Vol_(this->particles_->template getVariableDataByName<Real>("VolumetricMeasure")),
      mass_(this->particles_->template getVariableDataByName<Real>("Mass")),
      normal_vector_(this->particles_->template getVariableDataByName<Vecd>("NormalDirection")),
      variable_(this->particles_->template registerStateVariableData<DataType>(variable_name)),
      heat_flux_(this->particles_->template registerStateVariableData<Real>("HeatFlux")),
      heat_source_(this->particles_->template registerStateVariableData<Real>("HeatSource")),
      splitting_index_(this->particles_->template registerStateVariableData<int>("SplittingIndex")),
      species_modified_(this->particles_->template registerStateVariableData<Real>("SpeciesModified")),
      species_recovery_(this->particles_->template registerStateVariableData<Real>("SpeciesRecovery")),
      parameter_recovery_(this->particles_->template registerStateVariableData<Real>("ParameterRecovery")),
      eta_regularization_(this->particles_->template registerStateVariableData<Real>("EtaRegularization")),
      residual_T_local_(this->particles_->template registerStateVariableData<Real>("ResidualTLocal")),
      residual_T_global_(this->particles_->template registerStateVariableData<Real>("ResidualTGlobal")),
      residual_k_local_(this->particles_->template registerStateVariableData<Real>("ResidualKLocal")),
      residual_k_global_(this->particles_->template registerStateVariableData<Real>("ResidualKGlobal")),
      variation_local_(this->particles_->template registerStateVariableData<Real>("VariationLocal")),
      variation_global_(this->particles_->template registerStateVariableData<Real>("VariationGlobal")),
      residual_after_splitting_(this->particles_->template registerStateVariableData<Real>("ResidualAfterSplitting"))
{
