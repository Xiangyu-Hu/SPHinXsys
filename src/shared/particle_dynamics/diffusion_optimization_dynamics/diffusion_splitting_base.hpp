...
OptimizationBySplittingAlgorithmBase<ParticlesType, VariableType>::
    OptimizationBySplittingAlgorithmBase(BaseInnerRelation &inner_relation, const std::string &variable_name) : LocalDynamics(inner_relation.getSPHBody()), DataDelegateInner<ParticlesType>(inner_relation),
                                                                                                                ...
                                                                                                                heat_flux_(*(this->particles_->template registerDiscreteVariable<Real>("HeatFlux"))),
                                                                                                                heat_source_(*(this->particles_->template registerDiscreteVariable<Real>("HeatSource"))),
                                                                                                                splitting_index_(*(this->particles_->template registerDiscreteVariable<int>("SplittingIndex"))),
                                                                                                                species_modified_(*(this->particles_->template registerDiscreteVariable<Real>("SpeciesModified"))),
                                                                                                                species_recovery_(*(this->particles_->template registerDiscreteVariable<Real>("SpeciesRecovery"))),
                                                                                                                parameter_recovery_(*(this->particles_->template registerDiscreteVariable<Real>("ParameterRecovery"))),
                                                                                                                eta_regularization_(*(this->particles_->template registerDiscreteVariable<Real>("EtaRegularization"))),
                                                                                                                residual_T_local_(*(this->particles_->template registerDiscreteVariable<Real>("ResidualTLocal"))),
                                                                                                                residual_T_global_(*(this->particles_->template registerDiscreteVariable<Real>("ResidualTGlobal"))),
                                                                                                                residual_k_local_(*(this->particles_->template registerDiscreteVariable<Real>("ResidualKLocal"))),
                                                                                                                residual_k_global_(*(this->particles_->template registerDiscreteVariable<Real>("ResidualKGlobal"))),
                                                                                                                variation_local_(*(this->particles_->template registerDiscreteVariable<Real>("VariationLocal"))),
                                                                                                                variation_global_(*(this->particles_->template registerDiscreteVariable<Real>("VariationGlobal"))),
                                                                                                                residual_after_splitting_(*(this->particles_->template registerDiscreteVariable<Real>("ResidualAfterSplitting")))
{
...
RegularizationByDiffusionAnalogy<ParticlesType, VariableType>::
    RegularizationByDiffusionAnalogy(BaseInnerRelation &inner_relation, const std::string &variable_name,
                                     Real initial_eta, Real variation) : OptimizationBySplittingAlgorithmBase<ParticlesType, VariableType>(inner_relation, variable_name),
...
UpdateRegularizationVariation<ParticlesType, VariableType>::
    UpdateRegularizationVariation(BaseInnerRelation &inner_relation, const std::string &variable_name) : OptimizationBySplittingAlgorithmBase<ParticlesType, VariableType>(inner_relation, variable_name){};
//=================================================================================================//
template <class ParticlesType, typename VariableType>
