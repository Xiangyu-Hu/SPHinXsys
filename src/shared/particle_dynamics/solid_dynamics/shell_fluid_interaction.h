...
#ifndef C7EB2D5C_9E9E_4375_97B0_9AF3E4B55409
#define C7EB2D5C_9E9E_4375_97B0_9AF3E4B55409
...
{
typedef DataDelegateContact<ShellParticles, BaseParticles> FluidShellContactData;
/**
...
class BaseFluidPressureForceOnShell : public LocalDynamics, public FluidShellContactData
{
  public:
    explicit BaseFluidPressureForceOnShell(BaseContactRelation &contact_relation)
        : LocalDynamics(contact_relation.getSPHBody()), FluidShellContactData(contact_relation), vel_ave_(*particles_->AverageVelocity()), acc_prior_(particles_->acc_prior_), acc_ave_(*particles_->AverageAcceleration()), n_(particles_->n_)
    {
    ...
    void interaction(size_t index_i, Real dt = 0.0)
    {
        ...
        for (size_t k = 0; k < contact_configuration_.size(); ++k)
        {
            ...
            for (size_t n = 0; n != contact_neighborhood.current_size_; ++n)
            {
                ...
                force -= (p_in_wall + p_k[index_j] - riemann_solver_k.DissipativePJump(u_jump)) * e_ij * contact_neighborhood.dW_ijV_j_[n] * particles_->ParticleVolume(index_i);
            }
        }
...
class BaseFluidForceOnShellUpdate : public PressureForceType
{
  public:
    ...
    BaseFluidForceOnShellUpdate(BaseContactRelation &contact_relation, ViscousForceOnShellType &viscous_force_on_solid)
        : PressureForceType(contact_relation), viscous_force_from_fluid_(viscous_force_on_solid.getViscousForceFromFluid()){};
...
#endif /* C7EB2D5C_9E9E_4375_97B0_9AF3E4B55409 */
