...
namespace SPH
{
    ...
    //              B_[index_i] = getCorrectionMatrix(local_configuration);
		...
		public:
			...
			inline void interaction(size_t index_i, Real dt = 0.0)
			{
				...
				/*if (hourglass_control_)
                {
                    ...
                    Vecd pseudo_b_n_jump = getLinearVariableJump(e_ij, r_ij, pseudo_b_n_[index_i] - b_n0_[index_i],
                                                                    transformation_matrix_[index_i].transpose() * F_b_bending_[index_i] * transformation_matrix_[index_i],
                                                                    pseudo_b_n_[index_j] - b_n0_[index_j],
                                                                    transformation_matrix_[index_j].transpose() * F_b_bending_[index_j] * transformation_matrix_[index_j]);
            ...
            Vecd local_dpseudo_b_n_d2t = transformation_matrix_[index_i] * dpseudo_b_n_d2t_[index_i];
                        dangular_b_vel_dt_[index_i] = Vec3d(0.0, 0.0, local_dpseudo_b_n_d2t[0]);
                        ...
                        dangular_vel_dt_[index_i] = Vec3d(0.0, local_dpseudo_n_d2t[0], 0.0); // getRotationFromPseudoNormalForSmallDeformation(Vec3d(local_dpseudo_b_n_d2t), Vec3d(local_dpseudo_n_d2t), Vec3d(rotation_[index_i]), Vec3d(angular_vel_[index_i]), dt);
			};
		...
		protected:
            ...
            const StdVec<Real> nine_gaussian_weights_2d_ = {25. / 81., 25. / 81., 25. / 81., 25. / 81., 40. / 81., 40. / 81., 40. / 81., 40. / 81., 64. / 81.};
		...
		public:
			...
			inline void interaction(size_t index_i, Real dt = 0.0)
			{
                ...
                dF_b_bending_dt_[index_i] = transformation_matrix_i * deformation_gradient_change_rate_part_three * transformation_matrix_i.transpose() * B_[index_i];
			};
