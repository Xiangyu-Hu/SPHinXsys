...
DensitySummation<Base, DataDelegationType>::DensitySummation(BaseRelationType &base_relation)
    : LocalDynamics(base_relation.getSPHBody()), DataDelegationType(base_relation),
      ...
      rho0_(this->body_.base_material_->ReferenceDensity()),
      inv_sigma0_(1.0 / this->body_.sph_adaptation_->LatticeNumberDensity()),
      W0_(this->body_.sph_adaptation_->getKernel()->W0(ZeroVecd)) {}
//=================================================================================================//
