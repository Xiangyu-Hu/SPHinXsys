...
{
typedef DataDelegateContact<BaseParticles, ShellParticles> FluidShellContactData;
typedef DataDelegateContact<BaseParticles, ShellParticles, DataDelegateEmptyBase> FluidShellData;
