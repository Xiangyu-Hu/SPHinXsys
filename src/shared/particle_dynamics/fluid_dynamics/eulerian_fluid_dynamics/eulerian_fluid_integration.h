    ...
    : public EulerianIntegration<DataDelegateInner>
{
  public:
    ...
    explicit EulerianIntegration1stHalf(InteractArgs<BodyRelationType, FirstArg> parameters)
    ...
    : public EulerianIntegration<DataDelegateInner>
{
  public:
    ...
    template <typename BodyRelationType, typename FirstArg>
    explicit EulerianIntegration2ndHalf(InteractArgs<BodyRelationType, FirstArg> parameters)
