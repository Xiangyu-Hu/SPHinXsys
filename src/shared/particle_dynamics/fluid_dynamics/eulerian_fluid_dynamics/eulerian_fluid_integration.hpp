...
EulerianIntegration<DataDelegationType>::EulerianIntegration(BaseRelationType &base_relation)
    : BaseIntegration<DataDelegationType>(base_relation),
      mom_(*this->particles_->template registerDiscreteVariable<Vecd>("Momentum")),
      dmom_dt_(*this->particles_->template registerDiscreteVariable<Vecd>("MomentumChangeRate")),
