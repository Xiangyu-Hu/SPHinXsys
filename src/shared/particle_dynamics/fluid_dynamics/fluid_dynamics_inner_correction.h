...
{
/**
 * @class BaseIntegration1stHalfInnerCorrect
 */
template <class RiemannSolverType>
class BaseIntegration1stHalfInnerCorrect : public BaseIntegration<FluidDataInner>
{
  public:
    explicit BaseIntegration1stHalfInnerCorrect(BaseInnerRelation &inner_relation);
    virtual ~BaseIntegration1stHalfInnerCorrect(){};
...
using Integration1stHalfInnerCorrect = BaseIntegration1stHalfInnerCorrect<NoRiemannSolver>;
/** define the mostly used pressure relaxation scheme using Riemann solver */
using Integration1stHalfInnerRiemannCorrect = BaseIntegration1stHalfInnerCorrect<AcousticRiemannSolver>;
} // namespace fluid_dynamics
} // namespace SPH
