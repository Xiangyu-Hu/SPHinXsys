...
{
    this->rho_[index_i] = ReinitializedDensity(this->rho_sum_[index_i], this->rho_[index_i]);
}
//=================================================================================================//
...
void DensitySummationFreeStream<DensitySummationFreeSurfaceType>::update(size_t index_i, Real dt)
{
    ...
    {
        this->rho_[index_i] = this->ReinitializedDensity(this->rho_sum_[index_i], this->rho_[index_i]);
    }
    else
    {
