...
class SolidBodyForSimulation
{
  private:
    ...
    InteractionWithUpdate<FirstConsistencyMatrixInner> correct_configuration_;
  ...
  public:
    ...
    InteractionWithUpdate<FirstConsistencyMatrixInner> *getCorrectConfiguration() { return &correct_configuration_; };
