...
TEST(test_optimization, test_problem4_optimized)
{
    ...
    Real initial_learning_rate = 0.00085;
    ...
    out_file_residual_plot << std::fixed << std::setprecision(12) << ite << "   " << averaged_residual_T_current_global << "   " << maximum_residual_T_current_global << "   " << averaged_residual_k_current_global << "   " << maximum_residual_k_current_global << "   " << averaged_variation_current_global << "   " << maximum_variation_current_global << "\n";

    out_file_all_information << std::fixed << std::setprecision(12) << ite_loop << "   " << ite << "   " << averaged_residual_T_current_local << "   " << averaged_residual_T_current_global << "   " << averaged_residual_k_current_local << "   " << averaged_residual_k_current_global << "   " << averaged_variation_current_local << "   " << averaged_variation_current_global << "\n";
           ...
           ite_loop < 5000)
    {
        ...
        while (((averaged_residual_T_current_global > 0.95 * averaged_residual_T_last_global) &&
                averaged_residual_T_current_global > 0.00002) ||
               ite_T < ite_T_total)
        {
            ite++;
            ite_T++;
