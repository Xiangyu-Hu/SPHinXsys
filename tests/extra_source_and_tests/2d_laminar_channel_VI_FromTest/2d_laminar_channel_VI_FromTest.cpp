...
std::vector<Vecd> water_block_shape{
    ...
    Vecd(DL,  DH), Vecd(DL, 0.0),  Vecd(-DL_sponge, 0.0)};
/** the outer wall polygon. */
std::vector<Vecd> outer_wall_shape{
    Vecd(-DL_sponge - BW, -BW), Vecd(-DL_sponge - BW, DH + BW),
    Vecd(DL + BW,  DH + BW), Vecd(DL + BW, 0.0 - BW), Vecd(-DL_sponge - BW, -BW)};
/** the inner wall polygon. */
std::vector<Vecd> inner_wall_shape{
    Vecd(-DL_sponge - 2.0 * BW, 0.0), Vecd(-DL_sponge - 2.0 * BW, DH),
    Vecd(DL + 2.0 * BW,  DH ), Vecd(DL + 2.0 * BW, 0.0), Vecd(-DL_sponge - 2.0 * BW, 0.0)};
//----------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    Vec2d disposer_up_halfsize = Vec2d(0.5 * BW, 0.75 * DH);
    Vec2d disposer_up_translation = Vec2d(DL, DH + 0.25 * DH) - disposer_up_halfsize;
