...
namespace SPH
{
    ...
    void AnisotropicDiffusionRelaxation<Contact<>>::relaxation_contact(Vec3d dimension, size_t index_i )
    {
        ...
        Mat3d Laplacian_transform = Mat3d { 
           ...
           Mat3d Laplacian_transform_aniso = diffusion_coeff_tensor_ * Laplacian_transform * diffusion_coeff_tensor_.transpose() ;
		...
		diffusion_dt_[index_i] = Laplacian_x[index_i] + Laplacian_y[index_i]+ Laplacian_z[index_i];
