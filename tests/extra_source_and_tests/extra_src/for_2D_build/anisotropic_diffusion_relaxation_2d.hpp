...
namespace SPH
{
    ...
    void AnisotropicDiffusionRelaxation<Contact<>>::relaxation_contact(Vec2d dimension, size_t index_i )
    {
        ...
        {   
            ...
            Vec3d total_right_2d_rate_contact = Vec3d::Zero();
            ...
            for (size_t n = 0; n != contact_neighborhood.current_size_; ++n)
            {
                ...
                total_right_2d_rate_contact += disp_quad_ * modified_func_contact * right_;
            
            }
            total_left_2d[index_i] += total_left_2d_rate_contact;
            total_right_2d[index_i] += total_right_2d_rate_contact;
       }       
        ...
        Mat2d Laplacian_transform = Mat2d { 
         ...
         Mat2d Laplacian_transform_aniso = diffusion_coeff_tensor_ * Laplacian_transform * diffusion_coeff_tensor_.transpose() ;
