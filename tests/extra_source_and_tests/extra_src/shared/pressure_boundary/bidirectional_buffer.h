...
class BidirectionalBuffer
{
    ...
    class Injection : public BaseDynamics<void>, public LocalDynamics, public GeneralDataDelegateSimple
    {
      public:
        ...
        Injection(ConcurrentIndexVector &buffer_particle_list, RealBody &real_body, SharedPtr<AlignedBoxShape> shape_ptr,
                  size_t body_buffer_width, int axis_direction, BidirectionalBuffer &buffer, bool prescribe_pressure) : BaseDynamics<void>(real_body), LocalDynamics(real_body), GeneralDataDelegateSimple(real_body),
  ...
  public:
    ...
    BidirectionalBuffer(RealBody &real_body, SharedPtr<AlignedBoxShape> shape_ptr,
                        size_t body_buffer_width, int axis_direction, bool prescribe_pressure = true) : prescribe_pressure(prescribe_pressure),
