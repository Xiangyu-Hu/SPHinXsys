...
GetSaturationTimeStepSize::GetSaturationTimeStepSize(SPHBody &sph_body)
    : LocalDynamicsReduce<ReduceMin>(sph_body),
      porous_solid_(DynamicCast<PorousMediaSolid>(this, sph_body_->getBaseMaterial())),
...
PorousMediaStressRelaxationFirstHalf::
    ...
    : BasePorousMediaRelaxation(body_inner_relation),
      Vol_update_(particles_->registerStateVariableData<Real>("UpdateVolume")),
      fluid_saturation_(particles_->registerStateVariableData<Real>("FluidSaturation")),
      total_mass_(particles_->registerStateVariableData<Real>("TotalMass")),
      fluid_mass_(particles_->registerStateVariableData<Real>("FluidMass")),
      dfluid_mass_dt_(particles_->registerStateVariableData<Real>("FluidMassIncrement")),
      total_momentum_(particles_->registerStateVariableData<Vecd>("TotalMomentum")),
      force_(particles_->registerStateVariableData<Vecd>("Force")),
      force_prior_(particles_->registerStateVariableData<Vecd>("ForcePrior")),
      fluid_velocity_(particles_->registerStateVariableData<Vecd>("FluidVelocity")),
      relative_fluid_flux_(particles_->registerStateVariableData<Vecd>("RelativeFluidFlux")),
      outer_fluid_velocity_relative_fluid_flux_(particles_->registerStateVariableData<Matd>("OuterFluidVelocityRelativeFluidFlux")),
