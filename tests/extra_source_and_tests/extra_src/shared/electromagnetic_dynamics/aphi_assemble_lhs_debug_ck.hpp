...
#include "electromagnetic_dynamics/aphi_assemble_lhs_debug_ck.h"
...
#include "electromagnetic_dynamics/aphi_gradient_divergence_debug_ck.hpp"
...
inline AphiAssembleLhsDebugDynamicsBundle<ExecutionPolicy>::AphiAssembleLhsDebugDynamicsBundle(
    ...
    : options_(options), names_(variable_names),
      ...
      div_a_real_diagnostic_(sph_body, variable_names.solution.a_real + "Gradient", variable_names.diagnostic.div_a_real),
      div_a_imag_diagnostic_(sph_body, variable_names.solution.a_imag + "Gradient", variable_names.diagnostic.div_a_imag),
