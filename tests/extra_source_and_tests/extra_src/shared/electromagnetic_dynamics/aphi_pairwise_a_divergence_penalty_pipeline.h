#ifndef APHI_PAIRWISE_A_DIVERGENCE_PENALTY_PIPELINE_H
#define APHI_PAIRWISE_A_DIVERGENCE_PENALTY_PIPELINE_H
...
/** Pairwise divA -> grad(divA) -> LhsA -= lambda*grad(divA); matches JacobiGradDivABlock PC. */
template <class ExecutionPolicy>
class AphiPairwiseADivergencePenaltyPipelineBundle
{
  public:
    AphiPairwiseADivergencePenaltyPipelineBundle(SPHBody &sph_body, Inner<> &inner_relation,
  ...
  protected:
    ...
    InteractionDynamicsCK<ExecutionPolicy, AphiPairwiseVectorDivergenceCK<Inner<>>> div_a_real_;
    InteractionDynamicsCK<ExecutionPolicy, AphiPairwiseVectorDivergenceCK<Inner<>>> div_a_imag_;
    InteractionDynamicsCK<ExecutionPolicy, AphiPairwiseScalarGradientCK<Inner<>>> div_a_real_gradient_;
    InteractionDynamicsCK<ExecutionPolicy, AphiPairwiseScalarGradientCK<Inner<>>> div_a_imag_gradient_;
...
#endif // APHI_PAIRWISE_A_DIVERGENCE_PENALTY_PIPELINE_H
