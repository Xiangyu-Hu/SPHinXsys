/**
 * Stage 7 convergence (c): full A-phi operator + phi gauge penalty.
 */
...
int main(int ac, char *av[])
{
    ...
    const UnsignedInt max_iterations = 400;
    ...
    std::cout << "test_3d_aphi_ck_bicgstab_full_aphi_penalty_convergence"
