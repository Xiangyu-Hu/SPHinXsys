/**
 * Stage 9C-3: simplified TEAM7-like plate/coil layout on unit box (no Contact).
 * Full sigma contrast; coupled PC GMRES m=50, outer=100, tol=5e-4.
 */
...
int main(int ac, char *av[])
{
    ...
    std::cout << "test_3d_aphi_ck_gmres_team7_like_coil_plate_simplified"
