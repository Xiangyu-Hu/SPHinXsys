...
int main(int ac, char *av[])
{
    ...
    AphiBiCGStabSolverCK<MainExecutionPolicy> solver(test_body.body, test_body.inner(), names, options, tolerance, 10);
    ...
    const bool passed = result.converged && !result.breakdown && result.iteration_count == 0 &&
                        result.initial_residual_norm < tolerance;

    std::cout << "test_3d_aphi_ck_bicgstab_exact_initial_guess"
