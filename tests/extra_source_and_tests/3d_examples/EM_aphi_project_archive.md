...
- `extra_src/shared/electromagnetic_aphi_global_implicit_solver.*`
- `extra_src/shared/electromagnetic_aphi_laplace_eigen.*`
- `extra_src/shared/electromagnetic_aphi_operator_comparison_eigen.*`
- `extra_src/shared/electromagnetic_component_hessian_ck.*`
- `extra_src/shared/electromagnetic_multiturn_coil_drive.*`
- `extra_src/shared/electromagnetic_team7_aphi_dynamics.*`
- `extra_src/shared/electromagnetic_team7_aphi_frequency_dynamics.*`
- `extra_src/shared/em_aphi_residual_diagnostics_snippet.hpp`
