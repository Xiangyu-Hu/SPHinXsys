/**
 * @file passive_cantilever_LG.cpp
 * @brief This is the first example of cantilever coupling with the Laguerre Gauss kernel
...
int main(int ac, char *av[])
{
    ...
    cantilever_body.defineMatterMaterial<Muscle>(rho0_s, bulk_modulus, fiber_direction, sheet_direction, a0, b0);
