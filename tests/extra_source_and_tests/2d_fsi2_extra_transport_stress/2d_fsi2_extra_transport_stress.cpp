 ...
 */
#include "2d_fsi2_extra_transport_stress.h" // case file to setup the test case
#include "sphinxsys.h"
using namespace SPH;
//----------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    //** For test */
    Dynamics1Level<fluid_dynamics::ExtraTransportForceComplex<AllParticles>> impose_extra_transport_force(water_block_inner, water_block_contact);
