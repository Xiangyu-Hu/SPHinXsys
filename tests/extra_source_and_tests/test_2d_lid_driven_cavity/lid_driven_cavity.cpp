...
int main(int ac, char *av[])
{
    ...
    write_fluid_states.addToWríte<Real>(fluid, "Pressure");
    write_fluid_states.addToWríte<Vecd>(no_slip_boundary, "NormalDirection");
    BodyStatesRecordingToVtp write_observation_states(observer_body);
    write_observation_states.addToWríte<Real>(observer_body, "VariableViscosity");
