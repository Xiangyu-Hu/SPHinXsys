...
import io
import numpy as np
import test_2d_flow_stream_around_fish_flap_pybind as test
...
class FISHTestEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self.train_fish = test.from_sph_relaxation_and_test(self.episode)  # generate configuration xml fish file
        self.center_x = 0.4
        self.center_y = 0.4
        self.init_x = 0.4
        self.init_y = 0.7
    ...
    def reset(self, seed=None, options=None):
        ...
        self.prev_x = 0.4
        self.prev_y = 0.7
        self.train_fish = test.from_sph_reload_and_test(self.episode)
        ...
        # mean_val = np.mean(self.obs)
        # std_val = np.std(self.obs)
        # observation = (self.obs - mean_val) / std_val
