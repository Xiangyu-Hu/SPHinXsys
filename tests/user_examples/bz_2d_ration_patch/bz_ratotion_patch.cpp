/**
 * @file	rotationpatch.cpp
 * @brief	2D rotationpatch example.
...
int main(int ac, char *av[])
{
    ...
    InteractionWithUpdate<ConsistencyCorrectedConfigurationInner> consistency_configuration_fluid(water_body_inner, 0.2);
