...
namespace SPH
{
	...
	*/
    class readMeshFile
    {
      public:
        ...
        string full_path_;
        vector<int> types_of_boundary_condition_;
        ...
        vector<vector<int>> elements_nodes_connection_;
        StdLargeVec<Vec3d> elements_neighbors_connection_;
        vector<vector<vector<int>>> cell_lists_;
    };
    ...
    */
    class BaseInnerRelationInFVM : public SPHRelation
    {
      ...
      public:
        RealBody *real_body_;
        vector<vector<vector<int>>> all_needed_data_from_mesh_file_;
        ...
        explicit BaseInnerRelationInFVM(RealBody &real_body, vector<vector<vector<int>>> data_inpute, vector<vector<Real>> nodes_coordinates);
    ...
    */
    class InnerRelationInFVM : public BaseInnerRelationInFVM
    {
      ...
      public:
        explicit InnerRelationInFVM(RealBody &real_body, vector<vector<vector<int>>> data_inpute, vector<vector<Real>> nodes_coordinates);
