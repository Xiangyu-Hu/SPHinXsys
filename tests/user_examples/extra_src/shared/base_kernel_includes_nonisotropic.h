 ...
 * -----------------------------------------------------------------------------*/
/**
 * @file 	base_kernel_includes_nonisotropic.h
...
#ifndef BASE_KERNELS_ANISOTROPIC_H
#define BASE_KERNELS_ANISOTROPIC_H
...
class Kernel
{
  ...
  public:
    ...
    explicit Kernel(Real h, Real kernel_size, Real rc_ref, const std::string &kernel_name);
    virtual ~Kernel(){};
...
#endif // BASE_KERNELS_ANISOTROPIC_H