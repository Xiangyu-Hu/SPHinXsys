...
{
  public:
    NoRiemannSolverEulerian(Fluid &fluid_i, Fluid &fluid_j)
...
class AcousticRiemannSolverEulerian : public NoRiemannSolverEulerian
{
  public:
    AcousticRiemannSolverEulerian(Fluid &fluid_i, Fluid &fluid_j)
        : NoRiemannSolverEulerian(fluid_i, fluid_j),
...
using EulerianIntegration1stHalfAcousticRiemannConsistency = EulerianIntegration1stHalfConsistency<AcousticRiemannSolverEulerian>;
using EulerianIntegration1stHalfNoRiemannConsistency = EulerianIntegration1stHalfConsistency<NoRiemannSolverEulerian>;
...
using EulerianIntegration2ndHalfAcousticRiemannConsistency = EulerianIntegration2ndHalfConsistency<AcousticRiemannSolverEulerian>;
using EulerianIntegration2ndHalfNoRiemannConsistency = EulerianIntegration2ndHalfConsistency<NoRiemannSolverEulerian>;
