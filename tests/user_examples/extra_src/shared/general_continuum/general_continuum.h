...
class J2Plasticity : public GeneralContinuum
{
  ...
  public:
    ...
    virtual Mat3d ConstitutiveRelationShearStress(const Mat3d &velocity_gradient, const Mat3d &shear_stress);
    ...
    virtual Mat3d ReturnMappingShearStress(const Mat3d &shear_stress);
    virtual Mat3d ReturnMappingShearStress(Mat3d &shear_stress, Real hardening_parameter);
    virtual int PlasticIndicator(const Mat3d &shear_stress);
