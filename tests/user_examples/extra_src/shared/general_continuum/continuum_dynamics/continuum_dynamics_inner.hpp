...
namespace SPH
{
	namespace continuum_dynamics
	{
		...
		BaseStressRelaxation1stHalf<RiemannSolverType>::BaseStressRelaxation1stHalf(BaseInnerRelation& inner_relation)
			...
			velocity_gradient_(particles_->velocity_gradient_), acc_deviatoric_plastic_strain_(particles_->acc_deviatoric_plastic_strain_), vertical_stress_(particles_->vertical_stress_), E_(plastic_continuum_.getYoungsModulus()), nu_(plastic_continuum_.getPoissonRatio()) {}
		//=================================================================================================//
		template <class RiemannSolverType>
