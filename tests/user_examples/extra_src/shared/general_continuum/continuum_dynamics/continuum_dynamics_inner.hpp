...
BaseStressRelaxation2ndHalf<RiemannSolverType>::BaseStressRelaxation2ndHalf(BaseInnerRelation &inner_relation)
    : BaseRelaxationPlastic(inner_relation), riemann_solver_(plastic_continuum_, plastic_continuum_),
      velocity_gradient_(particles_->velocity_gradient_), Vol_(particles_->Vol_),
      mass_(particles_->mass_), von_mises_stress_(particles_->von_mises_stress_),
      acc_deviatoric_plastic_strain_(particles_->acc_deviatoric_plastic_strain_),
      vertical_stress_(particles_->vertical_stress_), E_(plastic_continuum_.getYoungsModulus()),
      nu_(plastic_continuum_.getPoissonRatio()) {}
//=================================================================================================//
template <class RiemannSolverType>
