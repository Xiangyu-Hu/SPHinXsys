/**
 * @file 	base_kernel_includes_nonisotropic.cpp
...
{
//=================================================================================================//
Kernel::Kernel(Real h, Real kernel_size, Real truncation, const std::string &kernel_name)
    : kernel_name_(kernel_name), h_(h), inv_h_(1.0 / h),
      kernel_size_(kernel_size),
      truncation_(truncation), rc_ref_(truncation * h),
      rc_ref_sqr_(rc_ref_ * rc_ref_),
