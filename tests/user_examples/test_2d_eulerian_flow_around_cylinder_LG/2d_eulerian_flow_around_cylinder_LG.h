/**
 * @file 	2d_eulerian_flow_around_cylinder_LG.h
 * @brief 	This is a test to show the standard eulerian flow around cylinder case coupling with the Laguerre Gauss kernel.
