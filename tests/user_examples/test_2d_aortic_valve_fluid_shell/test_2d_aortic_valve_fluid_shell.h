...
Real resolution_ref = 0.6 * scale;      /**< Global reference resolution. */
...
Real thickness = 0.6 * scale;                          /**< Thickeness of the beam. */
...
Real Q_max = 8.8 * 1e-3 / 60;  /**< Maximum flow rate in a period. */
...
Real Youngs_modulus = 1.5e4; /**< Youngs Modulus. */
