...
class WallBoundary : public ComplexShape
{
  public:
    ...
    {
        add<TransformShape<GeometricShapeBox>>(Transform(outer_wall_translation), inner_wall_halfsize);
...
int main(int ac, char *av[])
{
    ...
    NearShapeSurface near_surface_wall(water_block, makeShared<WallBoundary>("WallBoundary"));
