...
int main(int ac, char *av[])
{
	...
	beam_body.addBodyStateForRecording<Vecd>("PriorAcceleration");
	beam_body.addBodyStateForRecording<Vecd>("Acceleration");
	...
	InteractionDynamics<granular_dynamics::ShearAccelerationRelaxation> granular_shear_acceleration(beam_body_inner);
	InteractionDynamics<granular_dynamics::AngularConservativeShearAccelerationRelaxation> 
		granular_shear_acceleration_angular_conservative(beam_body_inner);
	...
	while (GlobalStaticVariables::physical_time_ < End_Time)
	{
		...
		while (integration_time < D_Time)
		{
			...
			{	
				//shear acceleration without angular conservative
				//granular_shear_acceleration.exec(dt);  

				//shear acceleration with angular conservative
				granular_shear_acceleration_angular_conservative.exec(dt);
