...
int main(int ac, char *av[])
{
	...
	//----------------------------------------------------------------------
    //RealBody triangle(sph_system, makeShared<Triangle>("Triangle"));
    /*RealBody triangle(sph_system, makeShared<ExclusiveShape<Triangle>>("Triangle"));
    triangle.defineBodyLevelSetShape()->writeLevelSet(io_environment);
	...
	/** Confinement condition for wall. */
