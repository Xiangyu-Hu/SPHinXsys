...
Real refer_energy = 0.5*8000*0.01;   
...
//----------------------------------------------------------------------
//	application boundary displacement condition
//----------------------------------------------------------------------
...
int main(int ac, char *av[])
{
	...
	while (GlobalStaticVariables::physical_time_ < End_Time)
	{
		...
		//the outer loop for stretching, also integrate time (loop) until the next output time
		while (integration_time < D_Time)
		{
			...
			Real refer_total_kinetic_energy = 1.0;
