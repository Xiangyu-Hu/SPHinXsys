/**
 * @file 	wfsi.h
 * @brief 	This is the case file for wave impact with tension leg floating tension.
 * @author   Nicolò Salis
 */
...
int main()
{
	...
	//----------------------------------------------------------------------
	std::cout << "AREA " << bp_area+ssp_area+psp_area+tp_area << std::endl;
	std::cout << "MASS " << rho_s*(bp_area+ssp_area+psp_area+tp_area) << std::endl;
	...
	*/
	...
	SimTK::MobilizedBody::Weld fixed_spotA( matter.Ground(), SimTK::Transform( 	
						SimTK::Vec3(tethering_pointA[0], tethering_pointA[1], 0.0) ),
						fixed_spot_info, SimTK::Transform(SimTK::Vec3(0.0, 0.0, 0.0)) );
	/*---------------------------------------------------------------------------*/
	SimTK::MobilizedBody::Weld fixed_spotB( matter.Ground(), SimTK::Transform( 	
	...
	*/
	SimTK::CableSpring tethering_springA(forces, tethering_lineA, 3.163E5, cablength, 10.);
	SimTK::CableSpring tethering_springB(forces, tethering_lineB, 3.163E5, cablength, 10.);
