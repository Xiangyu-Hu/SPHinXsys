...
Real StructureMass = 80; /* Weight of the solid structure*/
//Real StructureMass = StructureVol*50; /* Weight of the solid structure*/
...
/**Inertia computed by cad*/
// Real Ix=0.0322738*Srho;
// Real Iy=0.022918*Srho;
// Real Iz=0.0188687*Srho;
...
//Vecd translation_str(+0.595, 12.106, 0.573);
...
// ComplexShape createStructureShape()
// {	
// 		ComplexShape(complex_shape){
// 		Vecd translation(-0.36, 12.286, 0.573);
// 		add<TriangleMeshShapeSTL>(stl_structure_path, translation, StructureScale);
// 		}
// }
...
// class CableReporter : public PeriodicEventReporter {
// public:
//     CableReporter(const MultibodySystem& mbs, 
...
//     CableSpring             cable1;
// };
// class WriteSimBodyStatesMOD : public SimBodyStatesIO<MobilizedBodyType>
// 	{
// 	public:
// 		WriteSimBodyStatesMOD(IOEnvironment &io_environment, SimTK::RungeKuttaMersonIntegrator &integ, MobilizedBodyType &mobody)
// 			: SimBodyStatesIO<MobilizedBodyType>(io_environment, integ, mobody){};
// 		virtual ~WriteSimBodyStatesMOD(){};

// 		virtual void writeToFile(size_t iteration_step) = 0;
// 	};
// class WriteSimBodyCableData : public WriteSimBodyStates<SimTK::CablePath>
// {
// protected:
// 	std::string filefullpath_;

// public:
// 	WriteSimBodyCableData(IOEnvironment &io_environment, SimTK::RungeKuttaMersonIntegrator &integ, SimTK::CablePath &cable);
// 	virtual ~WriteSimBodyCableData(){};
// 	virtual void writeToFile(size_t iteration_step = 0) override;
// };

// class WriteSimBodyStructurePosition : public WriteSimBodyStates<SimTK::CablePath>
// {
// protected:
// 	std::string filefullpath_;

// public:
// 	WriteSimBodyStructurePosition(IOEnvironment &io_environment, SimTK::RungeKuttaMersonIntegrator &integ, SimTK::MobilizedBody::Planar &structure);
// 	virtual ~WriteSimBodyStructurePosition(){};
// 	virtual void writeToFile(size_t iteration_step = 0) override;
// };
//----------------------------------------------------------------------
//	Water block
