...
int main()
{
	...
	*/
	...
	std::cout << "Position structure center of mass" << std::endl;
	std::cout <<"Computed G: "<< G[0] <<" "<< G[1] <<" "<< G[2] << std::endl;
	std::cout <<"Simbody G: "<< structure_multibody.initial_mass_center_[0] <<" "<< structure_multibody.initial_mass_center_[1] <<" "<< structure_multibody.initial_mass_center_[2] << std::endl;
	std::cout << "Position of seaside cable ends with respect to the structure center of mass" << std::endl;
	std::cout << structure_tethering_AR[0] <<" "<< structure_tethering_AR[1] <<" "<< structure_tethering_AR[2] << std::endl;
	std::cout << structure_tethering_AL[0] <<" "<< structure_tethering_AL[1] <<" "<< structure_tethering_AL[2] << std::endl;
	std::cout << structure_tethering_BR[0] <<" "<< structure_tethering_BR[1] <<" "<< structure_tethering_BR[2] << std::endl;
	std::cout << structure_tethering_BL[0] <<" "<< structure_tethering_BL[1] <<" "<< structure_tethering_BL[2] << std::endl;
	std::cout << "Position of portside cable ends with respect to the structure center of mass" << std::endl;
	std::cout << disp_cable_endAR[0] <<" "<< disp_cable_endAR[1] <<" "<< disp_cable_endAR[2] << std::endl;
	std::cout << disp_cable_endAL[0] <<" "<< disp_cable_endAL[1] <<" "<< disp_cable_endAL[2] << std::endl;
	std::cout << disp_cable_endBR[0] <<" "<< disp_cable_endBR[1] <<" "<< disp_cable_endBR[2] << std::endl;
	std::cout << disp_cable_endBL[0] <<" "<< disp_cable_endBL[1] <<" "<< disp_cable_endBL[2] << std::endl;
	getchar();
	...
	*/
	SimTK::CableSpring tethering_springAR(forces, tethering_lineAR, 3.163E5, cablength, 10.);
	SimTK::CableSpring tethering_springAL(forces, tethering_lineAL, 3.163E5, cablength, 10.);
	SimTK::CableSpring tethering_springBR(forces, tethering_lineBR, 3.163E5, cablength, 10.);
	SimTK::CableSpring tethering_springBL(forces, tethering_lineBL, 3.163E5, cablength, 10.);
	...
	while (GlobalStaticVariables::physical_time_ < end_time)
	{
		...
		while (integral_time < output_interval)
		{
			...
			if (total_time >= relax_time)
			{	
				//std::cout << "offset: " << "x=" <<  << " y="  << OffS[1] <<  std::endl;
				write_str_displacement.writeToFile(number_of_iterations);
				write_WM_displacement.writeToFile(number_of_iterations);
				wave_gauge.writeToFile(number_of_iterations);
