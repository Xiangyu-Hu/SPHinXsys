...
int main(int ac, char *av[])
{
    ...
    //----------------------------------------------------------------------
    InteractionWithUpdate<ComplexInteraction<CorrectionMatrixInner, CorrectionMatrixContact>>
        corrected_configuration_fluid(LocalDynamicsParameters(water_block_complex.getInnerRelation(), 2, 0.3), water_block_complex.getContactRelation());
