...
/** the obstacle. */
Real offset_dist_for_n = 0.0 * resolution_ref;
std::vector<Vecd> obstacle_upper
{
	...
	Vecd(DL2- offset_dist_for_n , DH2),
	Vecd(DL2 + BW * 2.0 , DH2),
	Vecd(DL2 + BW * 2.0 , DH2 - obstacle_height + BW ), //*extending outlet
	...
	Vecd(DL2 + BW ,  DH2 - obstacle_height),
	Vecd(DL2 - offset_dist_for_n ,  DH2 - obstacle_height + BW),
	//Vecd(DL2 ,  DH2 - obstacle_height),
};
std::vector<Vecd> obstacle_lower
{
	Vecd(DL2- offset_dist_for_n , -DE),

	Vecd(DL2- offset_dist_for_n , -(DE - obstacle_height)-BW),
	...
	Vecd(DL2 + BW * 2.0 , -(DE - obstacle_height) -1.0 * BW), //*extending outlet	
	Vecd(DL2 + BW * 2.0 , -DE),
	Vecd(DL2 - offset_dist_for_n ,  -DE),
};
