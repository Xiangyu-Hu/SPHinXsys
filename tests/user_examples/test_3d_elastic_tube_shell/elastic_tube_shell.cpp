...
int main()
{
    std::cout << "Re = " << rho0_f * U_max * diameter / mu_f << std::endl;
    /**
    ...
    InteractionDynamics<solid_dynamics::FluidViscousForceOnShell> viscous_force_on_solid(wall_boundary_contact);
    ...
    SimpleDynamics<thin_structure_dynamics::ConstrainShellBodyRegion> constrain_wall(wall_fixed);
        ...
        while (integration_time < Output_Time)
        {
            ...
            while (relaxation_time < Dt)
            {
                ...
                while (dt_s_sum < dt)
                {
                    ...
                    wall_rotation_damping.exec(dt_s);
                    constrain_wall.exec();
            ...
            // update curvature before update configuration
