...
int main()
{
	...
	StructureSystemForSimbody structure_multibody(structure, makeShared<MultiPolygonShape>(createFltStr(), "StructureMultiBody"));
	...
	*/
	...
	/**
	  ...
	  */
	SimTK::MobilizedBody::Planar structure_mob(matter.Ground(), SimTK::Transform(SimTK::Vec3(G[0],G[1], 0.0)), structure_info, SimTK::Transform(SimTK::Vec3(0.0, 0.0, 0.0)));
	/**
	...
	ReduceDynamics<solid_dynamics::TotalForceOnBodyPartForSimBody>
		force_on_structure(structure_multibody, MBsystem, structure_mob, force_on_bodies, integ);
	SimpleDynamics<solid_dynamics::ConstraintBodyPartBySimBody>
		constraint_on_structure(structure_multibody, MBsystem, structure_mob, force_on_bodies, integ);
	//----------------------------------------------------------------------
