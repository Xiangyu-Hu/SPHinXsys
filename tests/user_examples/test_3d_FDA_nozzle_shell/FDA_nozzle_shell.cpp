...
BoundingBox system_domain_bounds(Vec3d(-upstream_length - wall_thickness, -diameter / 2 - shell_thickness, -diameter / 2 - shell_thickness),
                                 Vec3d(downstream_length + wall_thickness, diameter / 2 + shell_thickness, diameter / 2 + shell_thickness));
//----------------------------------------------------------------------
