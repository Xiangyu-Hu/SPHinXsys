...
const Real wall_thickness = 1.6 * unit_scale;
...
BoundingBox system_domain_bounds(Vec3d(inlet_center[0] - wall_extension, -radius - wall_thickness, -radius - wall_thickness),
                                 Vec3d(outlet_center_1[0] + wall_extension, radius + wall_thickness, 12.0));
//----------------------------------------------------------------------
...
// wall
const std::string path_to_wall_file = "./input/wall_1_6.stl";
...
int main(int ac, char *av[])
{
    ...
    SolidBody wall_boundary(sph_system, makeShared<WallShape>("wall_1_6"));
    wall_boundary.defineAdaptationRatios(1.15, resolution_ref / resolution_wall);
