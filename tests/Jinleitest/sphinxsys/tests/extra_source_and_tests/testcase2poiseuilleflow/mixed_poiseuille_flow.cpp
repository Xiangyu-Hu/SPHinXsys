...
Real resolution_ref = DH / 25.0;                             /**< Initial reference particle spacing. */
...
//     size_t number_observation_points = 56;
...
//     {
//         Vec2d point_coordinate(resolution_ref * 75.0, range_of_measure * (Real)i / (Real)(number_observation_points - 1) + start_of_measure);
