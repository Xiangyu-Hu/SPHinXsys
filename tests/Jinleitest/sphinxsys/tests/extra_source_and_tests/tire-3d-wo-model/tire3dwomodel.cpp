...
BoundingBox system_domain_bounds(Vec3d(-10.0, -10.0,-10.0), Vec3d(10.0,10.0,10.0));

//----------------------------------------------------------------------
// Tire geometry (3D circular ring)
//----------------------------------------------------------------------
class Tire : public ComplexShape {
public:
    explicit Tire(const std::string &shape_name) : ComplexShape(shape_name) 
    {
        add<TriangleMeshShapeCylinder>(SimTK::UnitVec3(0.0, 0.0, 1.0), R_outer, 0.5 * tire_thickness, 20, Vec3d(road_length*0.5,road_height+R_outer, 0.0));
        subtract<TriangleMeshShapeCylinder>(SimTK::UnitVec3(0.0, 0.0, 1.0), R_inner-rim_thickness, 0.5 * tire_thickness, 20, Vec3d(road_length*0.5,road_height+R_outer, 0.0));
    }
};
...
// road (solid domain)
//----------------------------------------------------------------------
class Road : public ComplexShape {
public:
    explicit Road(const std::string &shape_name) : ComplexShape(shape_name) {
        add<TriangleMeshShapeBrick>(Vec3d(0.5*road_length,0.5*road_height,1.0),10, Vec3d(road_length*0.5,road_height*0.5, 0.5));
    }
};
...
public:
    explicit WaterBlock(const std::string &shape_name) : ComplexShape(shape_name) {
        add<TriangleMeshShapeBrick>(Vec3d(0.5*road_length,0.01,1.0),20, Vec3d(road_length*0.5,0.005, 0.5));
    }
};
...
// ComplexShape createRimBaseShape()
// {
//     ComplexShape rim;
//     rim.add<TriangleMeshShapeCylinder>(SimTK::UnitVec3(0.0, 0.0, 1.0), R_inner+tire_thickness, 0.5 * tire_thickness, 50, Vec3d(road_length*0.5,road_height+R_outer, 0.0));
//     rim.subtract<TriangleMeshShapeCylinder>(SimTK::UnitVec3(0.0, 0.0, 1.0), R_inner, 0.5 * tire_thickness, 50, Vec3d(road_length*0.5,road_height+R_outer, 0.0));
//     return rim;
// }
//----------------------------------------------------------------------
// define Tire Motion
...
int main(int ac, char *av[]) {
    ...
    BodyStatesRecordingToVtp write_tire_to_vtp(tire);
    write_tire_to_vtp.writeToFile(0);
