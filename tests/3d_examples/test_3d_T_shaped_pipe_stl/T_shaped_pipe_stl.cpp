...
int main(int ac, char *av[])
{
	...
	BodyRegionByParticleWithFace emitter(water_body, inlet_face, 2);
	InflowInjectingWithFace emitter_inflow_injecting(water_body, emitter, 10);

	/** Define inflow condition. */
	BodyRegionByCellsWithFace emitter_buffer(water_body, inlet_face, 2);
	...
	BodyRegionByCellsWithFace face1(water_body, outlet_face_1);
	BodyRegionByCellsWithFace face2(water_body, outlet_face_2);
	/** recycle real fluid particle to buffer particles at outlet. */
	DoNothingConditionWithFace outflow1(water_body, face1);
	DoNothingConditionWithFace outflow2(water_body, face2);

	/**/
	// ModifiedDoNothingConditionWithFace outflow1(water_body, face1);
	// ModifiedDoNothingConditionWithFace outflow2(water_body, face2);
