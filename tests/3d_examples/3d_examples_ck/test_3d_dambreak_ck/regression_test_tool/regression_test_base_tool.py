...
class SphinxsysRegressionTestByCTest:
    ...
    def run_case(self) -> None:
        ...
        command = f".{os.sep}{self.sphinxsys_case_name} --state_recording=false --regression=true"
        os.system(self.enter_sphinxsys_exec_folder)
        os.system(command)
        print('Simulating case is finished...')
    ...
    def run_case_with_reload(self) -> None:
        ...
        print(self.enter_sphinxsys_exec_folder)
        command = f".{os.sep}{self.sphinxsys_case_name} --reload=true --state_recording=false --regression=true"
        os.system(self.enter_sphinxsys_exec_folder)
        os.system(command)
        print('Simulating case is finished...')
