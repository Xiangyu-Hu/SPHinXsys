...
// handle command line arguments
    ...
    InteractionWithUpdate<FirstConsistencyMatrixInner> correct_configuration_excitation(physiology_heart_inner);
    ...
    /** Active mechanics. */
    InteractionWithUpdate<FirstConsistencyMatrixInner> correct_configuration_contraction(mechanics_heart_inner);
    /** Observer Dynamics */
