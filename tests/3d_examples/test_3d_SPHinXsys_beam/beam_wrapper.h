#include "SPHinXsys_beam_dynamics.h"
...
struct bar_algorithm
{
    ...
    Dynamics1Level<slender_structure_dynamics::BeamStressRelaxationFirstHalf> stress_relaxation_first_half;
    Dynamics1Level<slender_structure_dynamics::BeamStressRelaxationSecondHalf> stress_relaxation_second_half;
    ...
    explicit bar_algorithm(InnerRelation &inner,
                           Real physical_viscosity,
                           size_t number_of_gaussian_points = 3,
                           bool hourglass_control = false)
        : corrected_configuration(inner),
          stress_relaxation_first_half(inner, number_of_gaussian_points, hourglass_control),
        ...
        : bar_body(std::make_unique<SolidBody>(system, makeShared<DefaultShape>(bar_params.body_name)))
    {
        ...
        alg = std::make_unique<bar_algorithm>(
            *inner_relation,
            ...
            bar_params.number_of_gaussian_points,
