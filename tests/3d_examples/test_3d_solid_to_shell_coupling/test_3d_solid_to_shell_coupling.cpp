...
void run_solid_to_shell_coupling(size_t res_factor_solid, size_t res_factor_shell, Real stiffness_ratio, bool run_relax)
{
    ...
    Real physical_viscosity = get_physical_viscosity_general(rho, SMAX(youngs_modulus_solid, youngs_modulus_shell), cube_length);
    ...
    // Observer
    StdVec<Vecd> observation_locations{Vec3d(0, 0.5 * dp_shell, 0)};
