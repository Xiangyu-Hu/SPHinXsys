/**
* @file 	3d_shell_shell_collision.cpp
* @brief 	This is the benchmark test of the 3D shell-shell contact formulations.
* @details  We consider the collisoin of an elastic ball bouncing in a spherical box.
* @details  Both the ball and box consist of only a shell-like thin layer of elastic solid.
...
public:
	...
	: ThinStructure(system, body_name)
	{
		...
		body_shape_.substract<TriangleMeshShapeShere>(ball_radius, resolution, translation_ball);
	}
};
/**
