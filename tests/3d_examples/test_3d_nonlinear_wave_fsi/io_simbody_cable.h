...
class SimBodyCableStatesIO
{
  ...
  public:
    SimBodyCableStatesIO(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, CableSpring &cable1)
        : io_environment_(*sph_system.io_environment_), integ_(integ), cable_(cable1){};
...
{
  public:
    WriteSimBodyCableStates(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, CableSpring &cable1)
        : SimBodyCableStatesIO<CableSpring>(sph_system, integ, cable1){};
...
{
  public:
    ReadSimBodyCableStates(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, CableSpring *cable1)
        : SimBodyCableStatesIO<CableSpring>(sph_system, integ, cable1){};
    ReadSimBodyCableStates(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, StdVec<CableSpring *> cables)
        : SimBodyCableStatesIO<CableSpring>(sph_system, integ, cables){};
...
class WriteSimBodyCableData : public WriteSimBodyCableStates<SimTK::CableSpring>
{
  ...
  public:
    WriteSimBodyCableData(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, SimTK::CableSpring &cable1, std::string cableinf);
...
WriteSimBodyCableData::
    WriteSimBodyCableData(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, SimTK::CableSpring &cable1, std::string cableinf)
    : WriteSimBodyCableStates<SimTK::CableSpring>(sph_system, integ, cable1),
