...
int main(int ac, char *av[])
{
    ...
    BodyRegionByCell damping_buffer(water_block, makeShared<TransformShape<GeometricShapeBox>>(Transformd(translation_damping), damping));
    ...
    BodyRegionByParticle wave_maker(wall_boundary, makeShared<TransformShape<GeometricShapeBox>>(Transformd(translation_wave_maker), wave_maker_shape));
