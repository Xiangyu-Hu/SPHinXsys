...
class SphereBody : public SolidBody
{
public:
	SphereBody(SPHSystem& system, std::string body_name)
		: SolidBody(system, body_name)
	{
		BoundingBox boundingBox(std::make_pair(Vec3d{ 0,0,0 }, Vec3d(4, 4, 4)));
		ImplicitSurface sphere;
		sphere.addAImplicitSphere({ 2,2,2 }, 1, boundingBox, 0.1);

		body_shape_.add<ComplexImplicitShape>(this, sphere);
...
int main(int argc, char **argv)
{
	...
	//----------------------------------------------------------------------
    BoundingBox boundingBox(std::make_pair(Vec3d{-1,-1,-1}, Vec3d(5,5,5)));
	SPHSystem system(boundingBox, 0.1);
	...
	//----------------------------------------------------------------------
	SphereBody inputbody(system, "sphere");
