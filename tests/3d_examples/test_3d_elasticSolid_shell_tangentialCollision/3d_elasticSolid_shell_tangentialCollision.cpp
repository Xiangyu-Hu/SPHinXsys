/**
* @file 	3d_elasticSolid_shell_tangentialCollision.cpp
* @brief 	This is a benchmark test of the 3D elastic solid->shell almost tangential contact/impact formulations.
* @details  We consider the collisoin of an elastic ball bouncing in a cylindrical shell box.
