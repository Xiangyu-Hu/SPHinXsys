...
class SphBasicGeometrySetting
{
  protected:
    ...
    MultiPolygon createWaveMakerShape()
    {
        ...
        MultiPolygon multi_polygon;
        multi_polygon.addPolygon(wave_make_shape, GeometricOps::add);
        return multi_polygon;
    }
    ...
    {
        MultiPolygon multi_polygon;
        multi_polygon.addPolygon(createFlapShape(), GeometricOps::add);
        return multi_polygon;
    }
...
class WaterBlock : public MultiPolygonShape, public SphBasicGeometrySetting
{
  public:
    explicit WaterBlock(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        multi_polygon_.addPolygon(createFlapShape(), GeometricOps::sub);
        multi_polygon_.addPolygon(createFlapConstrainShape(), GeometricOps::sub);
    }
};
...
class WallBoundary : public MultiPolygonShape, public SphBasicGeometrySetting
{
  public:
    explicit WallBoundary(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        multi_polygon_.addPolygon(createFlapConstrainShape(), GeometricOps::add);
        multi_polygon_.addPolygon(createInnerWallShape01(), GeometricOps::sub);
        multi_polygon_.addPolygon(createInnerWallShape02(), GeometricOps::sub);
    }
};
...
class Flap : public MultiPolygonShape, public SphBasicGeometrySetting
{
  public:
    ...
    {
        multi_polygon_.addPolygon(createFlapShape(), GeometricOps::add);
    }
};
