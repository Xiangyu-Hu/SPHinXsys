...
int main(int ac, char *av[])
{
    ...
    ComplexRelation water_block_complex(water_block, RealBodyVector{&wall_boundary, &shell_baffle});
    ...
    InteractionWithUpdate<fluid_dynamics::DensitySummationFreeSurfaceComplex> update_fluid_density_by_summation(water_block_complex);
    ...
    {
        write_baffle_displacement.testResult();
    }
