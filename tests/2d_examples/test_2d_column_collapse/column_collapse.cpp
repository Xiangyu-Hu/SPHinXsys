...
int main(int ac, char *av[])
{
    ...
    body_states_recording.addToWríte<Real>(soil_block, "Pressure");
    body_states_recording.addToWríte<Real>(soil_block, "Density");
    body_states_recording.addToWríte<Real>(soil_block, "VerticalStress");
    body_states_recording.addToWríte<Real>(soil_block, "AccDeviatoricPlasticStrain");
    body_states_recording.addToWríte<Vecd>(wall_boundary, "NormalDirection");
