...
// handle command line arguments
    ...
    Dynamics1Level<fluid_dynamics::Integration1stHalfRiemannCorrectWithWall> pressure_relaxation_correct(water_block_complex);
    Dynamics1Level<fluid_dynamics::Integration1stHalfRiemannConsistencyCorrectWithWall> pressure_relaxation_consistency(water_block_complex);
    ...
    InteractionDynamics<fluid_dynamics::TransportVelocityConsistencyCorrectionComplex<AllParticles>> transport_velocity_consistency(water_block_complex);
