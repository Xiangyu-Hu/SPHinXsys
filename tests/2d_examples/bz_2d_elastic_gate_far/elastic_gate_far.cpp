...
class WallBoundary : public MultiPolygonShape
{
  public:
    explicit WallBoundary(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        gate_constrain_shape.push_back(GateP_lb);
        gate_constrain_shape.push_back(GateP_lt);
        gate_constrain_shape.push_back(GateP_rt);
        gate_constrain_shape.push_back(GateP_rb);
        gate_constrain_shape.push_back(GateP_lb);

        multi_polygon_.addAPolygon(outer_wall_shape, ShapeBooleanOps::add);
        multi_polygon_.addAPolygon(inner_wall_shape, ShapeBooleanOps::sub);
        multi_polygon_.addAPolygon(gate_constrain_shape, ShapeBooleanOps::sub);
    }
};
//----------------------------------------------------------------------
//	create a gate shape
