...
int main(int ac, char *av[])
{
    ...
    body_states_recording.addToWríte<Matd>(water_block, "SurfaceTensionStress");
    body_states_recording.addToWríte<Vecd>(air_block, "ForcePrior");
    body_states_recording.addToWríte<Real>(air_block, "Density");
    body_states_recording.addToWríte<Real>(air_block, "Pressure");
