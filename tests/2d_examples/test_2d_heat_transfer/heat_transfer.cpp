...
int main()
{
	...
	Dynamics1Level<fluid_dynamics::PressureRelaxationRiemannWithWall> pressure_relaxation(fluid_body_complex);
	Dynamics1Level<fluid_dynamics::DensityRelaxationWithWall> density_relaxation(fluid_body_complex);
