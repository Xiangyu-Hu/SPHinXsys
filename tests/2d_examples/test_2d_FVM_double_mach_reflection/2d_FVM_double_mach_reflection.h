...
//----------------------------------------------------------------------
std::string double_mach_reflection_mesh1_fullpath = "double_mach_reflection_0.05.msh";
std::string double_mach_reflection_mesh2_fullpath = "double_mach_reflection_0.0125.msh";
std::string double_mach_reflection_mesh3_fullpath = "double_mach_reflection_0.012.msh";
//
