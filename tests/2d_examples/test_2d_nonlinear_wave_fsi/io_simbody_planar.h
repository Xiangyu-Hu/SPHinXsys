...
class WriteSimBodyPlanarData : public WriteSimBodyStates<SimTK::MobilizedBody::Planar>
{
  ...
  public:
    WriteSimBodyPlanarData(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, SimTK::MobilizedBody::Planar &planarbody);
...
WriteSimBodyPlanarData::
    WriteSimBodyPlanarData(SPHSystem &sph_system, SimTK::RungeKuttaMersonIntegrator &integ, SimTK::MobilizedBody::Planar &planarbody)
    : WriteSimBodyStates<SimTK::MobilizedBody::Planar>(sph_system, integ, planarbody),
