...
MultiPolygon createStructureShape()
{
    ...
    multi_polygon_.addPolygon(sructure_bp, GeometricOps::add);
    multi_polygon_.addPolygon(sructure_ssp, GeometricOps::add);
    multi_polygon_.addPolygon(sructure_psp, GeometricOps::add);
    multi_polygon_.addPolygon(sructure_tp, GeometricOps::add);
...
class WaterBlock : public MultiPolygonShape
{
  public:
    explicit WaterBlock(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        multi_polygon_.addPolygon(sructure_bp, GeometricOps::sub);
        multi_polygon_.addPolygon(sructure_ssp, GeometricOps::sub);
        multi_polygon_.addPolygon(sructure_psp, GeometricOps::sub);
        multi_polygon_.addPolygon(sructure_tp, GeometricOps::sub);
        multi_polygon_.addPolygon(sructure_mdp, GeometricOps::sub);
    }
};
...
class WallBoundary : public MultiPolygonShape
{
  public:
    explicit WallBoundary(const std::string &shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        multi_polygon_.addPolygon(Wmak_shape, GeometricOps::add);
    }
};
...
MultiPolygon createWaveMakerShape()
{
    ...
    multi_polygon.addPolygon(Wmak_shape, GeometricOps::add);
