...
int main(int ac, char *av[])
{
    ...
    InteractionWithUpdate<fluid_dynamics::DensitySummationFreeStreamComplex> update_density_by_summation(ConstructorArgs(water_block_inner, 0.0), water_wall_contact);
