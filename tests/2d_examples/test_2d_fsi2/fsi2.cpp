...
int main(int ac, char *av[])
{
    ...
    PeriodicConditionUsingCellLinkedList periodic_condition(water_block, water_block.getSPHBodyBounds(), xAxis);
    //----------------------------------------------------------------------
    //	Algorithms of FSI.
    //----------------------------------------------------------------------
    ...
    InteractionWithUpdate<solid_dynamics::PressureForceFromFluid> pressure_force_from_fluid(insert_body_contact);
