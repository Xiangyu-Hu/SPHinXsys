 ...
 */
#include "carotid.h" // case file to setup the test case
#include "sphinxsys.h"
using namespace SPH;
//----------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    ParticleBuffer<ReserveSizeFactor> inlet_particle_buffer(5);
    ...
    //=====================================================这一块是根据T型管学来的控制两出口一入口流动
    Vec2d emitter_halfsize = Vec2d(0.5 * BW, 0.5 * 5);
    Vec2d emitter_translation = Vec2d(-DL_sponge, 0) + emitter_halfsize;
    ...
    Vec2d inlet_flow_buffer_halfsize = Vec2d(0.5 * DL_sponge, 0.5 * 5);
    Vec2d inlet_flow_buffer_translation = Vec2d(-DL_sponge, 0) + inlet_flow_buffer_halfsize;
    ...
    Vec2d disposer_up_halfsize = Vec2d(0.5 * BW, 1);
    Vec2d disposer_up_translation = Vec2d(50, 10) - disposer_up_halfsize;
    ...
    Vec2d disposer_down_translation = Vec2d(50, -4) + disposer_down_halfsize;
    ...
    while (GlobalStaticVariables::physical_time_ < end_time)
    {
        ...
        while (integration_time < output_interval)
        {
            ...
            /** inflow injection可能是记录发射入口和出口信息的**/
