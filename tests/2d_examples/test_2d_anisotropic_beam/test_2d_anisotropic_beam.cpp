...
Real Total_PL = PL + SL;	//beam length
int x_num = Total_PL / resolution_ref_large;
...
class EulerCorrectConfiguration :
	public LocalDynamics, public  GeneralDataDelegateInner
{
public: 
	 EulerCorrectConfiguration(BaseInnerRelation &inner_relation, int beta = 0, Real alpha = Real(0))
...
int main(int ac, char *av[])
{
	...
	beam_body.generateParticles<NonisotropicParticleGenerator>();
	...
	InteractionWithUpdate<EulerCorrectConfiguration> beam_corrected_configuration(beam_body_inner);
