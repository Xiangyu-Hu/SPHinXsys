...
int main(int ac, char *av[])
{
	...
	NewInteractionDynamics<solid_dynamics::CorrectConfiguration> free_ball_corrected_configuration(free_ball_inner);
	NewInteractionDynamics<solid_dynamics::CorrectConfiguration> damping_ball_corrected_configuration(damping_ball_inner);
