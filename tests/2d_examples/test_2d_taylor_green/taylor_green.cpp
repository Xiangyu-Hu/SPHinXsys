...
int main(int ac, char *av[])
{
    ...
    InteractionWithUpdate<fluid_dynamics::TransportVelocityCorrectionInner<ZeroGradientLimiter, AllParticles>> transport_velocity_correction(water_block_inner);
