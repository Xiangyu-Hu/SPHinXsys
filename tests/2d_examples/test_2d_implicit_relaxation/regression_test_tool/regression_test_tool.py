...
"""
case name: test_2d_implicit_relaxation
"""

case_name = "test_2d_implicit_relaxation"
body_name = "Body"
parameter_name = "TotalParticleKineticEnergy"


number_of_run_times = 0
converged = 0
sphinxsys = SphinxsysRegressionTest(case_name, body_name, parameter_name)
sphinxsys.clean_input_folder(sphinxsys.input_file_path)
