...
namespace SPH
{
	...
	void  SPHBody::AllocateMemoriesForConfiguration()
	{
		...
		current_configuration_.resize(number_of_particles_, 
			make_tuple<NeighborList, size_t, size_t>(NeighborList(0), 0, 0));
		reference_configuration_.resize(number_of_particles_, 
			make_tuple<NeighborList, size_t, size_t>(NeighborList(0), 0, 0));
	...
	void SPHBody::AllocateConfigurationMemoriesForBodyBuffer(size_t body_buffer_particles)
	{
		...
		current_configuration_.resize(updated_size,
			make_tuple<NeighborList, size_t, size_t>(NeighborList(0), 0, 0));
		reference_configuration_.resize(updated_size,
			make_tuple<NeighborList, size_t, size_t>(NeighborList(0), 0, 0));
