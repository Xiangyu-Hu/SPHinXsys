...
namespace SPH
{
	...
	//=================================================================================================//
	ParticleGeneratorMultiResolution::ParticleGeneratorMultiResolution(SPHBody &sph_body): ParticleGeneratorLattice(sph_body),
	...
	//=================================================================================================//
	void ParticleGeneratorMultiResolution::initializePositionAndVolumetricMeasure(const Vecd &position, Real volume)
	{
	...
	//=================================================================================================//
	ThickSurfaceParticleGeneratorLattice::ThickSurfaceParticleGeneratorLattice(SPHBody &sph_body, Real global_avg_thickness)
