...
namespace SPH
{
	...
	namespace solid_dynamics
	{
		...
		{
			particles_->registerVariable(cauchy_stress_, "CauchyStress");
		}
		//=================================================================================================//
		void CauchyIntegration1stHalf::initialization(size_t index_i, Real dt)
		{
			...
			//obtain the Cauchy stress 
			cauchy_stress_[index_i] = elastic_solid_.StressCauchy(almansi_strain, F_[index_i], index_i)* inverse_F_T * B_[index_i];
		}
		//=================================================================================================//
