...
namespace SPH
{
	namespace fluid_dynamics
	{
		 ...
		 */
		class InitialNumberDensity
			: public ParticleDynamicsComplex<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles, SolidBody, SolidBodyParticles>
		{
		protected:
			Real W0_;
		...
		public:
			InitialNumberDensity(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
				: ParticleDynamicsComplex(body, interacting_bodies) { W0_ = body->kernel_->W(Vecd(0)); };
		 ...
		 */
		class DensityBySummation
			: public ParticleDynamicsComplexWithUpdate<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles, SolidBody, SolidBodyParticles>
		{
		protected:
			Real W0_;
			virtual void InnerInteraction(size_t index_particle_i, Real dt = 0.0) override;
		...
		public:
			DensityBySummation(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
			: ParticleDynamicsComplexWithUpdate(body, interacting_bodies) { W0_ = body->kernel_->W(Vecd(0)); };
		...
		public:
			DensityBySummationFreeSurface(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
		...
		protected:
			...
			virtual void Update(size_t index_particle_i, Real dt = 0.0) override;
		public:
			DivergenceCorrection(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
				: ParticleDynamicsComplexWithUpdate(body, interacting_bodies) {	dimension_ = Real(Vecd(0).size());	};
		};
		...
		protected:
			...
			virtual void ContactInteraction(size_t index_particle_i, size_t interacting_body_index, Real dt = 0.0) override;
		public:
			ComputingViscousAcceleration(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
				: ParticleDynamicsComplex(body, interacting_bodies) {
				mu_ = body->material_->mu_;
		...
		public:
			TransportVelocityStress(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
				: ParticleDynamicsComplex(body, interacting_bodies) {};
		...
		public:
			TransportVelocityCorrection(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
				: ParticleDynamicsComplex(body, interacting_bodies) {};
		 ...
		 * @brief  observe the total kinetic energy
		 */
		class TotalMechanicalEnergy 
			: public ParticleDynamicsSum<Real, WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles>
		{
		protected:
		...
		public:
			explicit TotalMechanicalEnergy(WeaklyCompressibleFluidBody* body, ExternalForce *external_force);
			virtual ~TotalMechanicalEnergy() {};
		};

		/**
		 * @class DambreakWaterFront
		 * @brief  observe water front for dam-break problems
		 */
		class DambreakWaterFront : public ParticleDynamicsMaximum<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles>
		{
		protected:
			Real smoothing_length_;
			...
			Real ReduceFunction(size_t index_particle_i, Real dt = 0.0) override;
		public:
			explicit DambreakWaterFront(WeaklyCompressibleFluidBody* body);
			virtual ~DambreakWaterFront() {};
		};
		...
		*/
		class GetAcousticTimeStepSize 
			: public ParticleDynamicsMaximum<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles>
		{
		protected:
			Real smoothing_length_;
			WeaklyCompressibleFluid *material_;
		...
		public:
			explicit GetAcousticTimeStepSize(WeaklyCompressibleFluidBody* body);
		...
		*/
		...
		protected:
			...
			Real OutputResult(Real reduced_value) override;
		public:
			explicit GetAdvectionTimeStepSize(WeaklyCompressibleFluidBody* body, Real U_f);
		...
		*/
		class ComputingVorticityInFluidField 
			: public ParticleDynamicsInner<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles>
		{
		protected:
			virtual void InnerInteraction(size_t index_particle_i, Real dt = 0.0) override;
		public:
			ComputingVorticityInFluidField(WeaklyCompressibleFluidBody *body) 
				: ParticleDynamicsInner(body) {};
		 ...
		 */
		class PressureRelaxationVerletFreeSurface 
			: public ParticleDynamicsComplex2Levels<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles, SolidBody, SolidBodyParticles>
		{
		protected:
			...
			virtual void Update(size_t index_particle_i, Real dt = 0.0) override;
		public:
			PressureRelaxationVerletFreeSurface(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies, ExternalForce *external_force)
				: ParticleDynamicsComplex2Levels(body, interacting_bodies), external_force_(external_force)
			{
		...
		public:
			PressureRelaxationVerlet(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies, ExternalForce *external_force)
				: PressureRelaxationVerletFreeSurface(body, interacting_bodies, external_force) {};
			PressureRelaxationVerlet(WeaklyCompressibleFluidBody *body, StdVec<SolidBody*> interacting_bodies)
		 ...
		 */
		class VerletOldroyd_B_Fluid : 
			public ParticleDynamicsComplex2Levels<Oldroyd_B_FluidBody, Oldroyd_B_FluidParticles, SolidBody, SolidBodyParticles>
		{
		protected:
			ExternalForce *external_force_;
			Oldroyd_B_Fluid *material_;
		...
		public:
			VerletOldroyd_B_Fluid(Oldroyd_B_FluidBody *body,
		 ...
		 */
		class InflowBoundaryCondition 
			: public EulerianConstraint<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles, FluidBodyPart>
		{
		protected:
		...
		public:
			InflowBoundaryCondition(WeaklyCompressibleFluidBody* body, FluidBodyPart *body_part)
				: EulerianConstraint<WeaklyCompressibleFluidBody, WeaklyCompressibleFluidParticles, FluidBodyPart>(body, body_part),
