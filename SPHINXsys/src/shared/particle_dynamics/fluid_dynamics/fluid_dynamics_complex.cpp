...
//=================================================================================================//
	namespace fluid_dynamics
	{
		...
		//=================================================================================================//
		FreeSurfaceIndicationComplex::FreeSurfaceIndicationComplex(ComplexBodyRelation* body_complex_relation, 
			Real thereshold) 
		: FreeSurfaceIndicationComplex(body_complex_relation->inner_relation_, 
		...
		//=================================================================================================//
		ColorFunctionGradientComplex::ColorFunctionGradientComplex(ComplexBodyRelation* body_complex_relation) 
		: ColorFunctionGradientComplex(body_complex_relation->inner_relation_, 
			body_complex_relation->contact_relation_){}
		//=================================================================================================//
