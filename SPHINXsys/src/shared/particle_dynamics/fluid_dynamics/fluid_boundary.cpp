...
namespace SPH
{
	...
	namespace fluid_dynamics
	{
		...
		FlowRelaxationBuffer::
			FlowRelaxationBuffer(FluidBody &fluid_body, BodyPartByCell &body_part, Real relaxation_rate)
			: PartDynamicsByCell(fluid_body, body_part), FluidDataSimple(fluid_body),
			  pos_(particles_->pos_), vel_(particles_->vel_), relaxation_rate_(relaxation_rate){};
		//=================================================================================================//
