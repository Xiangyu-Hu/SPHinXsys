...
namespace SPH
{
	...
	protected:
		...
		StdVec<CellDataLists> bound_cells_data_;
		...
		public:
			PeriodicBounding(Vecd &periodic_translation,
							 StdVec<CellLists> &bound_cells, StdVec<CellDataLists> &bound_cells_data,
				...
				: BoundingAlongAxis(real_body, bounding_bounds, axis),
				  ...
				  bound_cells_(bound_cells), bound_cells_data_(bound_cells_data){};
	...
	public:
		PeriodicConditionUsingCellLinkedList(RealBody &real_body, BoundingBox bounding_bounds, int axis)
			: BasePeriodicCondition(real_body, bounding_bounds, axis),
			  bounding_(periodic_translation_, bound_cells_, bound_cells_data_, real_body, bounding_bounds, axis),
			  update_cell_linked_list_(periodic_translation_, bound_cells_, bound_cells_data_, real_body, bounding_bounds, axis){};
	...
	protected:
		...
		public:
			CreatPeriodicGhostParticles(Vecd &periodic_translation,
										...
										RealBody &real_body, BoundingBox bounding_bounds, int axis)
				: PeriodicBounding(periodic_translation, bound_cells, bound_cells_data, real_body, bounding_bounds, axis),
	...
	public:
		PeriodicConditionUsingGhostParticles(RealBody &real_body, BoundingBox bounding_bounds, int axis)
			: BasePeriodicCondition(real_body, bounding_bounds, axis),
			  bounding_(periodic_translation_, bound_cells_, bound_cells_data_, real_body, bounding_bounds, axis),
			  ghost_creation_(periodic_translation_, bound_cells_, bound_cells_data_, ghost_particles_, real_body, bounding_bounds, axis),
			  ghost_update_(periodic_translation_, bound_cells_, bound_cells_data_, ghost_particles_, real_body, bounding_bounds, axis)
		{
	...
	protected:
		...
		CellDataLists bound_cells_data_;
