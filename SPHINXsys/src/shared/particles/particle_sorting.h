...
namespace SPH {
	...
	protected:
		...
		tbb::interafce9::internal::QuickSortParticleRange<size_t*, 
			CompareParticleSequence, SwapParticleData>* quick_sort_particle_range_;
		tbb::interafce9::internal::QuickSortParticleBody<size_t*, 
			CompareParticleSequence, SwapParticleData> quick_sort_particle_body_;
	public:
